...
echo "test 4: get search items by popularity: expect to succeed"
serverless invoke local -f get_items_popularity -p ~/BoilerX/backend-api/mocks/search-items/success.json > $outFile
